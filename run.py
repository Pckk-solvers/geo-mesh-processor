...
オプション:
    ...
    --standard-mesh PATH   標準地域メッシュ
    --mesh-id COLUMN       メッシュID
    --help                ヘルプを表示
"""
import argparse
import sys
...
def parse_args():
    ...
    parser.add_argument('--points-csv', nargs='+', help='点群CSVファイルのパス（複数指定可）', default="input2/標高点群_part3.csv;input2/標高点群_part4.csv")
    ...
    parser.add_argument('--standard-mesh', help='標準地域メッシュ', default=r"C:\Users\yuuta.ochiai\Documents\GitHub\shp_to_asc_converter\input\標準地域メッシュshp\標準地域メッシュ_trimmed.shp")
    parser.add_argument('--mesh-id', help='メッシュID', default=None)
